...
using mvc5_first.Data_Access_Layer;
...
namespace mvc5_first.Controllers
{
    public class PokemonBusinessLayer
    {
        ...
        public PokemonListViewModel GetView()
        {
#if Debug
            System.Data.Entity.Database.SetInitializer(new DropCreateDatabaseIfModelChanges<PokemonDal>());
#endif
